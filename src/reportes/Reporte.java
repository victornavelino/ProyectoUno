...
public class Reporte {
    ...
    public void reporteProyectoConvocatoria(ProyectoWeb proyecto) {
        try {
            ...
            ParticipacionWeb director=ParticipacionWebFacade.getInstance().getDirector(proyecto);
            ParticipacionWeb subdirector=ParticipacionWebFacade.getInstance().getSubDirector(proyecto);
            parameters.put("director", director);
            parameters.put("subdirector", subdirector);
