...
public class diagLineaPrioritariaAlta extends javax.swing.JDialog {
    ...
    public diagLineaPrioritariaAlta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                diagLineaPrioritariaAlta dialog = new diagLineaPrioritariaAlta(new javax.swing.JFrame(), true);
