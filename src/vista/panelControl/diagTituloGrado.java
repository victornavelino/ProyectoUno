 ...
 * @author carlos
 */
public class diagTituloGrado extends javax.swing.JDialog {

    private TituloGrado tituloGrado;
    private String tipoOperacion;

    /** Creates new form diagTituloGradoAlta */
    public diagTituloGrado(java.awt.Frame parent, boolean modal, String tipoOperacion) {
        super(parent, modal);
    ...
    public diagTituloGrado(java.awt.Frame parent, boolean modal, String tipoOperacion, TituloGrado tituloGrado) {
        super(parent, modal);
        this.tipoOperacion = tipoOperacion;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                diagTituloGrado dialog = new diagTituloGrado(new javax.swing.JFrame(), true, new String());
    ...
    private void inicializarComponentes() {
        if (tipoOperacion.equals("Alta")) {
            ...
            tfDescripcion.setText(tituloGrado.toString());
    ...
    private void aceptar() {
        if (tipoOperacion.equals("Alta")) {
            ...
            TituloGradoFacade.getInstance().alta(tituloGrado);
        } else if (tipoOperacion.equals("Modificación")) {
            tituloGrado.setDescripcion(tfDescripcion.getText());
    ...
    public TituloGrado getTituloGradoCreada() {
        return tituloGrado;
    }
}
