 ...
 * @author hugo
 */
public class diagProyectoAreaTematicaPModificar extends javax.swing.JDialog {
     ...
     */
    public diagProyectoAreaTematicaPModificar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    public diagProyectoAreaTematicaPModificar(java.awt.Frame parent, boolean modal, AreaTematica areaTematica) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCerrar.setText(org.openide.util.NbBundle.getMessage(diagProyectoAreaTematicaPModificar.class, "diagProyectoAreaTematicaPModificar.btnCerrar.text")); // NOI18N
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagProyectoAreaTematicaPModificar.class, "diagProyectoAreaTematicaPModificar.jPanel2.border.title"))); // NOI18N
        ...
        btnModificarProyecto1.setText(org.openide.util.NbBundle.getMessage(diagProyectoAreaTematicaPModificar.class, "diagProyectoAreaTematicaPModificar.btnModificarProyecto1.text")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diagProyectoAreaTematicaPModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diagProyectoAreaTematicaPModificar dialog = new diagProyectoAreaTematicaPModificar(new javax.swing.JFrame(), true);
    ...
    private void inicializarComponentes() {
      ...
      Comunes.cargarJList(jlistDisciplinas, DisciplinaCientificaFacade.getInstance().getDisciplinaCientifica(areaTematica));
    }

    
    private void eliminarDisciplina() {
        if(jlistDisciplinas.getSelectedIndex()!=-1){
            DisciplinaCientifica disciplina1 = (DisciplinaCientifica) jlistDisciplinas.getSelectedValue();
                if(SubDisciplinaCientificaFacade.getInstance().getSubDisciplinas(disciplina1).isEmpty()){
                    DisciplinaCientificaFacade.getInstance().eliminar(disciplina1.getId());
                    inicializarComponentes();
                }else{
                    int resolver = JOptionPane.showConfirmDialog(null, "El elemento escogido tiene Subdisciplicas asociadas \n"
                            + "desea resolver el conflicto?", "Error", JOptionPane.YES_NO_OPTION);
                    if (resolver == JOptionPane.YES_OPTION) {
                        diagProyectoDisciplinaPModificar diagProyectoMod = new diagProyectoDisciplinaPModificar(null, true, disciplina1);
