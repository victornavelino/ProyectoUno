...
import facade.proyecto.vinculacion.FinanciacionGenericaFacade;
 ...
 * @author Panchi
 */
public class diagGenerica2 extends javax.swing.JDialog {
    ...
    private FinanciacionGenerica generica;
    ...
    public diagGenerica2(java.awt.Frame parent, boolean modal, String tipoOperacion,
...
//modificacion
    ...
    public diagGenerica2(java.awt.Frame parent, boolean modal, String tipoOperacion,
            FinanciacionGenerica financiacionGenerica, Usuario usuario, ProyectoVinculacion proyectoVinculacion) {
        super(parent, modal);
        this.tipoOperacion = tipoOperacion;
        this.generica = financiacionGenerica;
        ...
        initComponents();
        this.setSize(new Dimension(Toolkit.getDefaultToolkit().getScreenSize()));
        jtfTipo.setText(generica.getDescripcion());
        inicializarComponentes();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton2.text")); // NOI18N
        ...
        jLabel11.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel11.text")); // NOI18N

        jTfcategoria.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTfcategoria.text")); // NOI18N

        jLabel27.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel27.text")); // NOI18N

        jTinstbeneficiaria.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTinstbeneficiaria.text")); // NOI18N

        jLabel9.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel9.text")); // NOI18N

        jTAinstitucionesproyecto.setColumns(20);
        jTAinstitucionesproyecto.setLineWrap(true);
        jTAinstitucionesproyecto.setRows(5);
        jScrollPane19.setViewportView(jTAinstitucionesproyecto);

        jTfrepinstben.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTfrepinstben.text")); // NOI18N
        jTfrepinstben.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTfrepinstbenActionPerformed(evt);
            }
        });

        jLabel28.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel28.text")); // NOI18N

        jLabel29.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel29.text")); // NOI18N

        jTfareatemaica.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTfareatemaica.text")); // NOI18N

        jLabel30.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel30.text")); // NOI18N

        jtfTipo.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfTipo.text")); // NOI18N
                ...
                .addGroup(jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel34Layout.createSequentialGroup()
                        .addGroup(jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTfrepinstben)
                            .addComponent(jTinstbeneficiaria)
                            .addComponent(jTfcategoria)
                            .addGroup(jPanel34Layout.createSequentialGroup()
                                .addComponent(jTfareatemaica, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addGap(3000, 3000, 3000))
                    .addGroup(jPanel34Layout.createSequentialGroup()
                        .addComponent(jtfTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 272, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addComponent(jPanel34, javax.swing.GroupLayout.PREFERRED_SIZE, 983, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel10.TabConstraints.tabTitle"), jPanel10); // NOI18N

        jPanel26.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel26.border.title"))); // NOI18N
        ...
        jButton18.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton18.text")); // NOI18N
        ...
        jButton4.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton4.text_1")); // NOI18N
        ...
        jPanel27.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel27.border.title"))); // NOI18N
        ...
        if (jTableBienesAAdquirir.getColumnModel().getColumnCount() > 0) {
            jTableBienesAAdquirir.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableBienesAAdquirir.columnModel.title0")); // NOI18N
            jTableBienesAAdquirir.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableBienesAAdquirir.columnModel.title1")); // NOI18N
            jTableBienesAAdquirir.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableBienesAAdquirir.columnModel.title2")); // NOI18N
            jTableBienesAAdquirir.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableBienesAAdquirir.columnModel.title3")); // NOI18N
            jTableBienesAAdquirir.getColumnModel().getColumn(4).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableBienesAAdquirir.columnModel.title4")); // NOI18N
        }

        jButton19.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton19.text")); // NOI18N
        ...
        jLabel38.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel38.text")); // NOI18N

        jtfbdcdC.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfbdcdC.text")); // NOI18N

        jtfbdcfc.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfbdcfc.text")); // NOI18N

        jLabel39.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel39.text")); // NOI18N

        jtfbdcfm.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfbdcfm.text")); // NOI18N

        jLabel40.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel40.text")); // NOI18N

        jtfbdctotal.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfbdctotal.text")); // NOI18N

        jLabel41.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel41.text")); // NOI18N

        jButton5.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton5.text_1")); // NOI18N
        ...
        jPanel15.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel15.border.title"))); // NOI18N
        ...
        jButton11.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton11.text")); // NOI18N
        ...
        jButton6.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton6.text_1")); // NOI18N
        ...
        jPanel16.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel16.border.title"))); // NOI18N
        ...
        jButton12.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton12.text")); // NOI18N
        ...
        jButton16.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton16.text")); // NOI18N
        ...
        jPanel17.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel17.border.title"))); // NOI18N

        jLabel12.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel12.text")); // NOI18N

        jLabel13.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel13.text")); // NOI18N

        jLabel14.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel14.text")); // NOI18N

        jLabel15.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel15.text")); // NOI18N

        jtfrhdc.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfrhdc.text")); // NOI18N

        jtfrhfc.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfrhfc.text")); // NOI18N

        jtfrhfm.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfrhfm.text")); // NOI18N

        jtfrhtotal.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfrhtotal.text")); // NOI18N
        ...
        jPanel19.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel19.border.title"))); // NOI18N
        ...
        jLabel16.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel16.text")); // NOI18N

        jLabel17.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel17.text")); // NOI18N

        jLabel18.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel18.text")); // NOI18N

        jtfConsultoriasC.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfConsultoriasC.text")); // NOI18N

        jtfConsultoriasM.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfConsultoriasM.text")); // NOI18N

        jtfConsultoriasTotal.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfConsultoriasTotal.text")); // NOI18N

        jButton13.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton13.text")); // NOI18N
        ...
        jButton21.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton21.text")); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel1.border.title"))); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel3.text")); // NOI18N

        jtfMaterialesC.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfMaterialesC.text")); // NOI18N

        jtfMaterialesM.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfMaterialesM.text")); // NOI18N

        jtfMaterialesTotal.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfMaterialesTotal.text")); // NOI18N

        jButton14.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton14.text")); // NOI18N
        ...
        jButton22.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton22.text")); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton22, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel20.TabConstraints.tabTitle"), jPanel20); // NOI18N

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel3.border.title"))); // NOI18N
        ...
        jButton1.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton1.text")); // NOI18N
        ...
        jButton23.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton23.text")); // NOI18N
        ...
        jPanel21.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel21.border.title"))); // NOI18N

        jLabel19.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel19.text")); // NOI18N

        jLabel20.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel20.text")); // NOI18N

        jLabel21.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel21.text")); // NOI18N

        jLabel22.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel22.text")); // NOI18N

        jtfRecDC.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfRecDC.text")); // NOI18N

        jtfRecFC.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfRecFC.text")); // NOI18N

        jtfRecFM.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfRecFM.text")); // NOI18N

        jtfRecTotal.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfRecTotal.text")); // NOI18N
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel4.border.title"))); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton3.text")); // NOI18N
        ...
        jButton24.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton24.text")); // NOI18N
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel2.TabConstraints.tabTitle"), jPanel2); // NOI18N

        jLabel25.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel25.text")); // NOI18N

        jScrollPane11.setViewportView(jListEtapas);

        jLabel26.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel26.text")); // NOI18N

        jtfDuracionTotalEtapa.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtfDuracionTotalEtapa.text")); // NOI18N

        jButton9.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton9.text")); // NOI18N
        ...
        jButton10.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton10.text")); // NOI18N
        ...
        jButton15.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton15.text")); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel5.border.title"))); // NOI18N
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel11.border.title"))); // NOI18N
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel6.TabConstraints.tabTitle"), jPanel6); // NOI18N

        jPanel12.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel12.border.title"))); // NOI18N
        ...
        if (jTableCronograma.getColumnModel().getColumnCount() > 0) {
            jTableCronograma.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableCronograma.columnModel.title0")); // NOI18N
            jTableCronograma.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableCronograma.columnModel.title1")); // NOI18N
            jTableCronograma.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableCronograma.columnModel.title2")); // NOI18N
            jTableCronograma.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTableCronograma.columnModel.title3")); // NOI18N
        }

        jButton7.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton7.text")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel6.text")); // NOI18N

        jLabel7.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel7.text")); // NOI18N

        jtftotaldesembolsos.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtftotaldesembolsos.text")); // NOI18N

        jtftotalcostos.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jtftotalcostos.text")); // NOI18N

        jButton25.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton25.text")); // NOI18N
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel7.TabConstraints.tabTitle"), jPanel7); // NOI18N

        jPanel8.setMaximumSize(new java.awt.Dimension(500, 3000));
        jPanel8.setPreferredSize(new java.awt.Dimension(500, 1822));

        jPanel22.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel22.border.title"))); // NOI18N

        jButton8.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton8.text")); // NOI18N
        ...
        jLabel8.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel8.text")); // NOI18N
        ...
        jPanel23.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel23.border.title"))); // NOI18N

        jButton17.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton17.text")); // NOI18N
        ...
        jLabel23.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel23.text")); // NOI18N
        ...
        jPanel24.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel24.border.title"))); // NOI18N

        jButton20.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton20.text")); // NOI18N
        ...
        jLabel24.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel24.text")); // NOI18N
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel8.TabConstraints.tabTitle"), jPanel8); // NOI18N

        jPanel28.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel28.border.title"))); // NOI18N
        ...
        jButton26.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton26.text")); // NOI18N
        ...
        jButton27.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton27.text")); // NOI18N
        ...
        jBtnReporteNe.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnReporteNe.text")); // NOI18N
        ...
        jButton30.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton30.text")); // NOI18N
        ...
        jPanel28Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel28Layout.createSequentialGroup()
                ...
                .addGroup(jPanel28Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton30, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel29.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel29.border.title"))); // NOI18N
        ...
        jButton28.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton28.text")); // NOI18N
        ...
        jButton29.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton29.text")); // NOI18N
        ...
        jBtnReporteNi.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnReporteNi.text")); // NOI18N
        ...
        jButton31.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jButton31.text")); // NOI18N
        ...
        jPanel29Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel29Layout.createSequentialGroup()
                ...
                .addGroup(jPanel29Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jBtnReporteNi, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
                    .addComponent(jButton31, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel9.TabConstraints.tabTitle"), jPanel9); // NOI18N

        jPanel31.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jBtnBuscarRendicion.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnBuscarRendicion.text")); // NOI18N
        ...
        jBtnAceptarRendicion.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnAceptarRendicion.text")); // NOI18N
        ...
        jBtnCancelarRendicion.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnCancelarRendicion.text")); // NOI18N
        ...
        jTfRendicionCuenta.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTfRendicionCuenta.text")); // NOI18N
        ...
        jLabel4.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel4.text")); // NOI18N

        jBtnEliminarRendicion.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnEliminarRendicion.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel5.text")); // NOI18N
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel30.TabConstraints.tabTitle"), jPanel30); // NOI18N

        jPanel33.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jBtnBuscarArchivo.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnBuscarArchivo.text")); // NOI18N
        ...
        jBtnAceptarArchivo.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnAceptarArchivo.text")); // NOI18N
        ...
        jBtnCancelarArchivo.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnCancelarArchivo.text")); // NOI18N
        ...
        jTfrutaArchivo.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jTfrutaArchivo.text")); // NOI18N
        ...
        jLabel10.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jLabel10.text_1")); // NOI18N

        jBtnEliminarFondo.setText(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jBtnEliminarFondo.text")); // NOI18N
        ...
        jTabbedPane2.addTab(org.openide.util.NbBundle.getMessage(diagGenerica2.class, "diagGenerica2.jPanel32.TabConstraints.tabTitle"), jPanel32); // NOI18N
    ...
    private void jTfrepinstbenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTfrepinstbenActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTfrepinstbenActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(diagGenerica2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                diagGenerica2 dialog = new diagGenerica2(new javax.swing.JFrame(), true, new String(), new Usuario(), new String());
        ...
        try {
            ...
            switch (tipoOperacion) {
                ...
                case "Modificacion":
                    setearTextField();
                    try {
                        if (generica.getEtapas() != null) {

                            etapas = generica.getEtapas();
                            cargarEtapas();
                            cargarCostosTotales();
                        }
...
//                }
                    ...
                    if (generica.getBienesdecapital() != null) {
                        bienesdisponibles = generica.getBienesdecapital();
                        cargarBienesDisponibles();
                        cargarBienDeCapitalDisponibleTotal();
                        cambiartotalBienes();

                    }
                    if (generica.getBienesdecapitaladquirir() != null) {
                        bienesaadquirir = generica.getBienesdecapitaladquirir();
                        cargarBienesAdquirir();
                    ...
                    if (generica.getRecursosHumanosDisponibles() != null) {
                        recursosdisponibles = generica.getRecursosHumanosDisponibles();
                        cargarRecursosDisponibles();
                    ...
                    if (generica.getRecursosHumanosAdquirir() != null) {
                        recursosadquirir = generica.getRecursosHumanosAdquirir();
                        cargarRecursosAdquirir();
                    ...
                    if (generica.getConsultorias() != null) {
                        consultorias = generica.getConsultorias();
                        cargarConsultorias();
                        cargarConsultoriasC();
                        cargarConsultoriasM();
                    ...
                    if (generica.getMateriales() != null) {
                        materiales = generica.getMateriales();
                        cargarMateriales();
                        cargarMaterialesC();
                        cargarMaterialesM();
                        cargarMaterialesTotal();
                    }
                    if (generica.getOtrosRecursoDisponibles() != null) {
                        otrosrecursosdisponibles = generica.getOtrosRecursoDisponibles();
                        cargarOtrosRecursosDisponibles();
                        cargarRecursosDisponiblesC();
                        cambiarOtrosRecursosTotal();
                    }
                    if (generica.getOtroRecursoAdquirir() != null) {
                        otrosrecursosadquirir = generica.getOtroRecursoAdquirir();
                        cargarOtrosRecursosAdquirir();
                        cargarRecursosAdquirirC();
                        cargarRecursosAdquirirM();
                        cambiarOtrosRecursosTotal();
                    }
                    if (generica.getCronogramasdepagos() != null) {
                        cronogramas = generica.getCronogramasdepagos();
                        cargarCronogramas();
                        cargarDesembolsoTotal();
                        cargarCostoTotal();

                    }
                    if (generica.getNotasExternas() != null) {
                        notasExternas = generica.getNotasExternas();
                        cargarNotasExternas();
                    }
                    if (generica.getNotasInternas() != null) {
                        notasInternas = generica.getNotasInternas();
                        cargarNotasInternas();
                    }
                    if (generica.getRendicioncuenta() != null) {
                        listaCuentas = generica.getRendicioncuenta();

                    }
                    if (generica.getRetiros() != null) {
                        fondos = generica.getRetiros();
                    }
    ...
    private void aceptar() {
        if (validar()) {
            switch (tipoOperacion) {
                case "Alta":
                    generica = new FinanciacionGenerica();
                    cargarDatos();

                    //   FinanciacionGenericaFacade.getInstance().alta(generica);
                    JOptionPane.showMessageDialog(null, "La Financiacion \""
                            + generica.getDescripcion() + "\" ha sido creada "
                            + "exitosamente");
                ...
                case "Modificacion":
                    cargarDatos();
                    //    FinanciacionGenericaFacade.getInstance().modificar(generica);
                    JOptionPane.showMessageDialog(null, "La Financiacion \""
                            + generica.getDescripcion() + "\" ha sido modificada"
                            + "exitosamente");
                    break;
            }
        }
    ...
    public FinanciacionGenerica getGenericaCreado() {
        return generica;
    }
    ...
    private void cargarDatos() {
        try {
            if (jTfareatemaica.getText() != null) {
                generica.setAreaTematica(jTfareatemaica.getText());
            } else {
                generica.setAreaTematica(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (jTfcategoria.getText() != null) {
                generica.setCategoria(jTfcategoria.getText());
            } else {
                generica.setCategoria(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (jTinstbeneficiaria.getText() != null) {
                generica.setInstitucionbeneficiaria(jTinstbeneficiaria.getText());
            } else {
                generica.setInstitucionbeneficiaria(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (jTfrepinstben.getText() != null) {
                generica.setRepresentanteinstben(jTfrepinstben.getText());
            } else {
                generica.setRepresentanteinstben(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (jTAinstitucionesproyecto.getText() != null) {
                generica.setInstitucionesproyecto(jTAinstitucionesproyecto.getText());
            } else {
                generica.setInstitucionesproyecto(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (jtfTipo.getText() != null) {
                generica.setDescripcion(jtfTipo.getText());


            } else {
                generica.setDescripcion(tipo);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (etapas.size() > 0) {
                generica.setEtapas(etapas);

            } else {
                generica.setEtapas(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (bienesdisponibles.size() > 0) {
                generica.setBienesdecapital(bienesdisponibles);
            } else {
                generica.setBienesdecapital(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (bienesaadquirir.size() > 0) {
                generica.setBienesdecapitaladquirir(bienesaadquirir);
            } else {
                generica.setBienesdecapitaladquirir(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (consultorias.size() > 0) {
                generica.setConsultorias(consultorias);

            } else {
                generica.setConsultorias(null);
        ...
        try {
            if (cronogramas.size() > 0) {
                agregarGenericaACronograma();
                generica.setCronogramasdepagos(cronogramas);

            } else {
                generica.setCronogramasdepagos(null);
        ...
        try {
            if (materiales.size() > 0) {
                generica.setMateriales(materiales);

            } else {
                generica.setMateriales(null);
        ...
        try {
            if (otrosrecursosadquirir.size() > 0) {
                generica.setOtroRecursoAdquirir(otrosrecursosadquirir);

            } else {
                generica.setOtroRecursoAdquirir(null);
        ...
        try {
            if (otrosrecursosdisponibles.size() > 0) {
                generica.setOtrosRecursoDisponibles(otrosrecursosdisponibles);

            } else {
                generica.setOtrosRecursoDisponibles(null);
        ...
        try {
            if (recursosadquirir.size() > 0) {
                generica.setRecursosHumanosAdquirir(recursosadquirir);

            } else {
                generica.setRecursosHumanosAdquirir(null);
        ...
        try {
            if (recursosdisponibles.size() > 0) {
                generica.setRecursosHumanosDisponibles(recursosdisponibles);

            } else {
                generica.setRecursosHumanosDisponibles(null);
        ...
        try {
            if (notasExternas.size() > 0) {
                generica.setNotasExternas(notasExternas);
            } else {
                generica.setNotasExternas(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (notasInternas.size() > 0) {
                generica.setNotasInternas(notasInternas);
            } else {
                generica.setNotasInternas(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (listaCuentas.size() > 0) {
                generica.setRendicioncuenta(listaCuentas);
            } else {
                generica.setRendicioncuenta(null);
            }
        } catch (NullPointerException ex) {
        }
        try {
            if (fondos.size() > 0) {
                generica.setRetiros(fondos);
            } else {
                generica.setRetiros(null);
            }
        } catch (NullPointerException ex) {
        }
    ...
    private void agregarGenericaACronograma() {
        for (CronogramaDePago c : cronogramas) {
            c.setFinanciacionId(generica.getId());
        }
    }
    ...
    private void generarReporteConvenio1() {
        if (proyectoVinculacion != null) {
            ...
            try {
                ...
                Logger.getLogger(diagGenerica2.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    private void generarReporteConvenio2() {
        if (generica != null && proyectoVinculacion != null) {
            String titulo = proyectoVinculacion.getTitulo();
            List<Anexo2> lista = new ArrayList<Anexo2>();
            for (Etapa e : generica.getEtapas()) {
                Anexo2 a = new Anexo2();
    ...
    private void generarReporteCronogramaDesembolsos() {
        if (generica != null && proyectoVinculacion != null) {
            ...
            for (CronogramaDePago c : generica.getCronogramasdepagos()) {
            ...
            // new reportes.Reporte().reporteFinanciacionCronograma(generica, proyectoVinculacion);
        } else {
            JOptionPane.showMessageDialog(null, "Debe guardar el formulario primero");
        } // TODO add your handling code here:
    }
    ...
    public void reporteSeguimientoNi() {
        ...
        List<NotaInterna> listaordenada = generica.getNotasInternas();
    ...
    private void reporteSeguimientoNe() {
        ...
        List<NotaExterna> listaordenada = generica.getNotasExternas();
    ...
    private void cargarRendiciones() {
        try {
            if (generica != null) {
                if (!generica.getRendicioncuenta().isEmpty()) {
                    Comunes.cargarJList(jListRendicion, generica.getRendicioncuenta());
                    listaCuentas = generica.getRendicioncuenta();
                } else {
        ...
        try {
            ...
            for (int i = 8; i < sheet.getRows(); i++) {
                ...
                if (!celda3.getContents().equals("")) {
                    op.setMonto(Float.valueOf(celda3.getContents()));
                }
                Cell celda4 = sheet.getCell(4, i);
                if (!celda4.getContents().equals("")) {
                    op.setSaldo(Float.valueOf(celda4.getContents()));
                }
    ...
    private void cargarFondos() {
        try {
            if (generica != null) {
                if (!generica.getRetiros().isEmpty()) {
                    Comunes.cargarJList(jListFondos, generica.getRetiros());
                    fondos = generica.getRetiros();
                } else {
    ...
    private void cargarDatosBasicos() {
        if (generica != null) {
            if (generica.getAreaTematica() != null) {
                jTfareatemaica.setText(generica.getAreaTematica());
            }

            if (generica.getCategoria() != null) {
                jTfcategoria.setText(generica.getCategoria());
            }

            if (generica.getInstitucionbeneficiaria() != null) {
                jTinstbeneficiaria.setText(generica.getInstitucionbeneficiaria());
            }
            if (generica.getRepresentanteinstben() != null) {
                jTfrepinstben.setText(generica.getRepresentanteinstben());
            }
            if (generica.getInstitucionesproyecto() != null) {
                jTAinstitucionesproyecto.setText(generica.getInstitucionesproyecto());
            }
